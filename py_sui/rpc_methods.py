...
class RPC:
    ...
    @staticmethod
    def dryRunTransaction(client, tx_bytes: Types.Base64, get_json: bool = False) -> Optional[dict or list]:
        params = [tx_bytes]
    ...
    @staticmethod
    def getObject(client, object_id: Types.ObjectID, get_json: bool = False) -> Optional[dict or list]:
        params = [object_id]
    ...
    @staticmethod
    def getObjectsOwnedByAddress(client, address: Types.SuiAddress, get_json: bool = False) -> Optional[dict or list]:
        params = [address]
    ...
    @staticmethod
    def getObjectsOwnedByObject(client, object_id: Types.ObjectID, get_json: bool = False) -> Optional[dict or list]:
        params = [object_id]
    ...
    @staticmethod
    def getRawObject(client, object_id: Types.ObjectID, get_json: bool = False) -> Optional[dict or list]:
        params = [object_id]
    ...
    @staticmethod
    def getTransactionsInRange(client, start: int, end: int, get_json: bool = False) -> Optional[dict or list]:
        params = [start, end]
    ...
    @staticmethod
    def subscribeEvent(client, filter: Types.EventFilter, get_json: bool = False) -> Optional[dict or list]:
        params = [filter]
